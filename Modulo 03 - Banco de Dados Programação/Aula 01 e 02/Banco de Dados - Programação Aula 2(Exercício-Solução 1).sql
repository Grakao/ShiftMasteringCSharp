...
-- PRODUTO
----------------------------------------
-- CONSTRAINT FOREIGN KEY E UNIQUE NO NÍVEL DE COLUNA
...
-- ITEM_PRODUTO
----------------------------------------
-- CONSTRAINTS FOREIGN KEY E CHECK NO NIVEL DE COLUNA  
...
-- CONSTRAINTS FOREIGN KEY E CHECK NO NIVEL DE TABELA  
DROP TABLE item_produto;
